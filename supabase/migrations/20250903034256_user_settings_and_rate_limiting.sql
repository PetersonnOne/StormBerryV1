-- User Settings and Rate Limiting Migration
-- This migration adds user settings storage and API rate limiting functionality

-- Add settings columns to profiles table (create if doesn't exist)
...
CREATE TABLE IF NOT EXISTS user_activity_log (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE,
  activity_type TEXT NOT NULL, -- 'ai_generation', 'voice_synthesis', 'voice_transcription', etc.

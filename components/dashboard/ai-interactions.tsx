...
export function AIInteractions() {
  const [interactions, setInteractions] = useState<AIInteraction[]>(mockInteractions)
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">${usageStats.totalCost.toFixed(3)}</p>
            </div>
          </div>
          <div>
            <div className="flex justify-between text-sm mb-2">
              <span>Monthly Limit</span>
              <span>{usageStats.thisMonth}/50 interactions</span>
            </div>
            <Progress value={(usageStats.thisMonth / 50) * 100} className="h-2" />
          </div>
        </CardContent>
      </Card>
